...
/**
 * This is a model event that is sent by the {@link ListDataModel}
 * implementations if anything is changed in encapsulated data.
 *
...
public class ListModelEvent {
	 ...
	 *
	 * @param source
	 *            is a data model produced this event.
	 * @param type
	 *            is an event type.
	 */
	 ...
	 *            is a data model produced this event.
	 * @param itemId
	 *            is a related item ID.
	 * @param itemIndex
	 *            is a related item index (usually index of the item identified
	 *            with <code>itemId</code>.
	 * @param type
	 *            is an event type.
	 */
	 ...
	 *            is a data model produced this event.
	 * @param itemIndexes
	 *            is a list of indexes mapped to their IDs. It must contain
	 *            items which were affected by model change.
	 * @param type
	 *            is an event type.
	 */
	public ListModelEvent(ListDataModel source,
			Map<String, Integer> itemIndexes, EventType type) {
		this.source = source;
	...
	public String getItemId() {
		return itemIndexes.isEmpty() ? null
				: itemIndexes.keySet().iterator().next();
	}
	...
	public int getItemIndex() {
		return itemIndexes.isEmpty() ? -1
				: itemIndexes.values().iterator().next();
	}
